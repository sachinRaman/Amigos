...
public class InterestsDAO extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL(
                "CREATE TABLE IF NOT EXISTS my_interests (tag varchar, interest varchar,pref INTEGER)"
        );
    }
    ...
    public ArrayList<InterestsVO> getAllInterests() {
        ...
        try {
            while (res.isAfterLast() == false) {
                ...
                InterestsVO curInterest = new InterestsVO(tag, interest, pref);
    ...
    public boolean changeInterest (String interest , int pref) {
    ...
    public boolean addInterestsToDB (String tag, String interest, int pref) {
