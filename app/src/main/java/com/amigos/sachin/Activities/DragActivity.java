...
public class DragActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tags1 = (TagContainerLayout) findViewById(R.id.tags1);
        tags2 = (TagContainerLayout) findViewById(R.id.tags2);
        tags3 = (TagContainerLayout) findViewById(R.id.tags3);
        tags4 = (TagContainerLayout) findViewById(R.id.tags4);

        scroll_tag1 = (ScrollView) findViewById(R.id.scroll_tag1);
        scroll_tag2 = (ScrollView) findViewById(R.id.scroll_tag2);
        scroll_tag3 = (ScrollView) findViewById(R.id.scroll_tag3);
        scroll_tag4 = (ScrollView) findViewById(R.id.scroll_tag4);

        saveButton = (Button) findViewById(R.id.saveInterests);

        scroll_tag1.setOnDragListener(new MyDragListener());
        scroll_tag2.setOnDragListener(new MyDragListener());
        scroll_tag3.setOnDragListener(new MyDragListener());
        scroll_tag4.setOnDragListener(new MyDragListener());

        tags1.setOnDragListener(new MyDragListener());
        tags2.setOnDragListener(new MyDragListener());
        tags3.setOnDragListener(new MyDragListener());
        tags4.setOnDragListener(new MyDragListener());
        ...
        saveButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(DragActivity.this,SplashScreen2.class);
        ...
        Intent intent1 = new Intent(context, MyInterestsUsageDirections.class);
    ...
    private void setListenerToTags(TagContainerLayout tags, int position ) {
        for (int i = 0; i<tags.getTags().size(); i++){
            ...
            tag.setOnTouchListener(new MyTouchListener());
            if(position == 1){
